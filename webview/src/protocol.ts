...
export type Outbound =
  ...
  // `mention` optionally pre-registers an @path label cited by the injected
  // text (addSelectionToChat's `@path#L…`), so the composer renders it as a
  // chip and attaches it as a file mention on send.
